...
public class BTNode<T>
{
  ...
  //Depends on how you implement height.  If a single node has height 0,
  // then the method below works.  If, however, you define the height of
  // a single node tree to be 1, then change the line marked *** below to return  // 1.
  public int height() {
    //tree should be not null
    int l = 0;
    int r = 0;
    if (left == null && right == null) {
	//***
	return 0; //only one node --> height is zero
    }
